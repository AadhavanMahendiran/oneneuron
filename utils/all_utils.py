...
def prepare_data(df):
  """it's used to seperate the dependent and independent features

  Args:
      df (pd.DataFrame): it's the pandas DataFrame to

  Returns:
      tuple: it return's the tuple of dependent variable and independent variable
  """
  X = df.drop("y", axis=1)
